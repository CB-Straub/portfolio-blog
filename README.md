A minimally viable music oriented blog using React and a pulling from a mockup jason-server database on the backend.  Frontend design, html and css are from scratch, no frameworks or bootstraps.  
